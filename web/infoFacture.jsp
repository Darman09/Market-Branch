                                    ...
                                    <div class="row section">
                                        <div class="col s12 m6 l6">
                                            <img class="mb-2 width-50"
                                                 src="../../../app-assets/images/logo/materialize-logo-big.png"
                                                 alt="company logo">
                                    ...
                                    <div class="row section">
                                        ...
                                        <div class="col s12 m6 l6">
                                            <div class="invoce-no right-align">
                                                <p><span class="text-uppercase strong">Invoice No.</span>
                                                    324/2019</p>
                                            </div>
                                            <div class="invoce-no right-align">
                                                <p><span class="text-uppercase strong">Invoice Date</span>
                                                    April 3 2018</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="invoice-footer mt-6">
                                    <div class="row">
                                        <div class="col s12 m6 l6">
                                            ...
                                            <ul>
                                                <li>You know, being a test pilot isn't always the healthiest
                                                    business in the world.</li>
                                                <li>We predict too much for the next year and yet far too
                                                    little for the next 10.</li>
                                            </ul>
                                        </div>
                                        <div class="col s12 m6 l6 center-align">
                                            <p>Approved By</p>
                                            <img src="../../../app-assets/images/misch/signature-scan.png"
                                                 alt="signature">
